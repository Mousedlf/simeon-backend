...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['user:read', 'users:read', 'trip:read', 'expense:new', 'conversation:read'])]
    private ?int $id = null;
    ...
    #[Groups(['user:read','users:read', 'trip:read','invites:read', 'expense:new', 'expense:index', 'conversation:read', 'message:read', 'participant:read'])]
